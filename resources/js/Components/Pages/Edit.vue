...
<script>
    ...
    export default {
        props: {
            ...
            page: Array,
            errors: Array,
            flash: Array,                    tags: Array,                                                categories: Array,    },
        components: {
        ...
        mounted() {
            console.log('Component mounted add tag.');
                            ...
                            this.form.created = this.page.created
                            this.form.modified = this.page.modified
                            this.form.category_id = this.page.category_id
                            this.form.published_date = moment(this.page.published_date).format('YYYY-MM-DD');                                for(let key in this.tags){
        ...
        methods: {
            submit() {
                ...
                this.form._csrfToken = this.token;
                    ...
                    this.$inertia.post('/pages/edit/' + this.form.id, this.form, {
                        onError: (errors) => {
